...
uses
  ...
  Image32, Image32_SVG_Core, Image32_Vector, Image32_Transform, Image32_SVG_Reader;
...
begin
  ...
  try
    ...
    if hashHtmlEntities then
      sl.SaveToFile('../html_entity_hash_consts.inc') else
      sl.SaveToFile('../Image32_SVG_Hash_Consts.inc');
  finally
    sl.Free;
    slNames.Free;
  end;
